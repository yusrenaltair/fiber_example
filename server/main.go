...
func main() {
	...
	app.Get("/test-api", middlware.RemoteProtected(), func(c *fiber.Ctx) error {
		return c.JSON(fiber.Map{"status": "success", "response_code": 200, "message": "this is the response", "data": nil})
	})
